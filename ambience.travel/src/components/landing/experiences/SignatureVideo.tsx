...
export default function SignatureVideo({ videoSrc, posterSrc }: Props) {
      ...
      {!loaded && (
        <div
          style={{
            ...
            inset:          0,
            zIndex:         0,
            background:     'linear-gradient(110deg, #0a0d0f 30%, #141e28 50%, #0a0d0f 70%)',
            backgroundSize: '200% 100%',
            animation:      'sigVideoShimmer 1.8s ease infinite',
          }}
        />
      )}
