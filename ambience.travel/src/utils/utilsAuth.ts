 ...
 *
 * Fields:
 *   first_name - required, stored in travel_clients.firstName
 *   last_name  - optional, stored in travel_clients.lastName
 *   nickname   - optional, stored in travel_clients.nickname + profiles.displayName fallback
 */
