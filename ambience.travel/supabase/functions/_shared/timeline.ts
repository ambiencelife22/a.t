  ...
  for (const b of bookings) {
    ...
    if (checkInDay) {
      ...
      out.push({
        ...
        guest_name: null, guest_count: null, reservation_status: null,
...
export function buildElementItems(aux: EngagementElementLike[]): TimelineItem[] {
  ...
  for (const a of aux) {
    ...
    out.push({
      ...
      reservation_status: (a.dining_status as string | null) ?? null,
      ...
      package_inclusions: (a.package_inclusions as string[] | null) ?? null,
      schedule: (a.schedule as TimelineItem['schedule']) ?? null,
