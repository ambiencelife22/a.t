  ...
  try {
    ...
    const fullBookings = bookings.map(b => {
      ...
      return {
        ...
        late_checkout_approved_time: b.late_checkout_approved_time ?? null,
        requested_checkin_time: b.requested_checkin_time ?? null,
        requested_checkout_time: b.requested_checkout_time ?? null,
        extras: b.extras ?? [],
